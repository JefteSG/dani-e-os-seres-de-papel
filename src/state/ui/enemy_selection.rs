...
pub fn draw_enemy_selection(enemies: &Vec<EnemyInfo>, selected_index: usize, emoji_font: Option<&Font>) {
    ...
    let instructions = "Use ← → ou A/D para navegar. Enter para selecionar.";
    let inst_size = 18.0;
    ...
    for (i, enemy) in enemies.iter().enumerate() {
        ...
        // Ícone/Emoji do inimigo (dinâmico)
    ...
    let progress_text = "Derrote os inimigos em ordem para desbloquear os próximos!";
